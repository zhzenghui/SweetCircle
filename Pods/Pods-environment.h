...
// ZHLib
#define COCOAPODS_POD_AVAILABLE_ZHLib
#define COCOAPODS_VERSION_MAJOR_ZHLib 0
#define COCOAPODS_VERSION_MINOR_ZHLib 0
#define COCOAPODS_VERSION_PATCH_ZHLib 1
